...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="">
          Hello, I'm <strong>Nicolas,</strong> a{" "}
          <strong>full-stack developer</strong> with{" "}
          <strong>1 year of experience.</strong> I enjoy taking on new
      ...
      >
        ...
        <a
          className="group bg-white rounded-full px-7 py-3
           flex items-center gap-2 outline-none
            focus:scale-110 hover:scale-110 active:scale-105
             cursor-pointer borderBlack dark:bg-gray-800"
          href="/Nicolas Cook Resume.pdf"
          download={true}
        >
          Download CV{" "}
        ...
        <a
          className="bg-white rounded-full px-5
           py-3 flex items-center gap-2 outline-none
            focus:scale-110 hover:scale-110 active:scale-105
