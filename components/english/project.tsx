    ...
    >
      <section
        className="bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative 
                        sm:h-[20rem] hover:bg-gray-200 transition group-even:pl-8 rounded-lg dark:bg-white/10 dark:hover:bg-white/20"
      >
        <div className="pt-4 pb-8 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[18rem]">
          ...
          <Image
            src={imageUrl}
            alt="Placeholder"
            className="absolute -right-40 top-8 w-[28.25rem] rounded-t-lg shadow-2xl group-even:right-[initial] 
